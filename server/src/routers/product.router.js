...
const {getProducts,handleSearch, handlecreateProduct, handlesingleProduct, handleDelete, handleUpdate} = require('../controllers/product.controller')
...
productRouter.get('/:search', handleSearch)
